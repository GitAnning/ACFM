...
class common_solver(solver.solver):
    ...
    def evaluate_model(self,param_dict):
        self.eval_mode()
        dataloader=param_dict["val"]
        counter=0.0
        evaluate_value=0.0
        evaluate_dict=None
        for step,data in enumerate(dataloader):
    ...
    def main(self,param_dict):
        ...
        for i in range(0,epochs):
            ...
            evaluate_value,evaluate_dict=self.evaluate_model(param_dict)
        ...
        tev,ted=self.test_model(param_dict)
